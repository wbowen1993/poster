...
column_name = ['id','title','adult','budget','date','duration','r','g','b','mainHue','avgHue','avgSat','avgLtn','actor-1','actor-2','actor-3','director']
genres_array = []
...
for i in range(40):
	...
	print "[",i+1,"/",len(movie_list),"] Being written.......","{0:.2f}".format(end_time - start_time),"s.........",'{:.2%}'.format(1.0*(i+1)/len(movie_list))
